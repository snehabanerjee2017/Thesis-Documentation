...
\begin{enumerate}
    ...
    \item \textbf{Reproducibility and Accessibility} A collection of tested models, dataset and algorithms are received on using a source library in the transfer learning paradigm. Hence it facilitates cooperation, repeatability and transparency for researchers, developers and other stakeholders.
