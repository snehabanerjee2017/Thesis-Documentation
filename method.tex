...
\end{enumerate}
After the convergence of the algorithm, $c$ medoid points are obtained which are the representative members of the $c$ clusters where $c \leq k$. Similar to the KMedoids algorithm, the Euclidean distance metric as shown in Eq. \ref*{eq:eq_dist} is used to compute the medoids. The pseudo-code for this algorithm is shown in \ref*{alg:multi_level_hdbscan}.
